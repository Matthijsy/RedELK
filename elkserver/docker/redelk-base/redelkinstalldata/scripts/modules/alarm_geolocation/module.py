...
class Module():
    ...
    def alarm_check(self):  # pylint: disable=no-self-use
        """ This check queries for geolocations that are not listed in allowlist_geolocation.conf
        ...
        # Build an ES filter that finds all logs with a geolocation not in the file
