...
class Module():
    ...
    def run(self):
        ...
        ret['info'] = info
        ret['fields'] = ['agent.hostname', 'source.ip', 'source.nat.ip', 'source.geo.country_iso_code', 'source.as.organization.name', 'redir.frontend.name', 'redir.backend.name', 'infra.attack_scenario', 'tags', 'redir.timestamp']
